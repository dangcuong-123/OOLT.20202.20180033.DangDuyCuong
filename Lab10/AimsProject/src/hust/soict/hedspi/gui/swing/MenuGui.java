...
public class MenuGui extends JFrame {
	...
	public MenuGui() {
		...
		label_5.setBounds(24, 231, 46, 14);
		...
		btnExit.setBounds(45, 228, 185, 23);
		getContentPane().add(btnExit);
		
		JLabel label_5_1 = new JLabel("5.");
		label_5_1.setFont(new Font("Tahoma", Font.BOLD, 13));
		label_5_1.setBounds(24, 205, 46, 14);
		getContentPane().add(label_5_1);
		
		JButton btnLucky = new JButton("Lucky Item");
		...
		btnLucky.setBounds(45, 202, 185, 23);
		getContentPane().add(btnLucky);
