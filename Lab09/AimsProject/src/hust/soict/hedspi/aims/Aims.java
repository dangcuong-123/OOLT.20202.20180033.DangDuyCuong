...
public class Aims {
        ...
        while (true){
            ...
            switch (line){
                ...
                case "2":
                    ...
                    switch (type){
                        case "1":
                            addBookToOrder(anOrder,scan);
                            break;
                        case "2":
                            addDvdToOrder(anOrder,scan);
                            break;
                        case "3":
                        	addCompactDisc(anOrder,scan);
                        	break;
                        case "0":
    ...
    private static void addDvdToOrder(Order anOrder, Scanner scan) {
        int id;
        do {
    ...
    private static void addBookToOrder(Order anOrder,Scanner scan) {
        int id;
        do {
            System.out.printf("\t\tEnter id: ");
            id = Integer.parseInt(scan.nextLine());
    ...
    private static void addCompactDisc(Order anOrder, Scanner scan) {
    	int id;
        do {
            System.out.printf("\t\tEnter id: ");
            id = Integer.parseInt(scan.nextLine());
