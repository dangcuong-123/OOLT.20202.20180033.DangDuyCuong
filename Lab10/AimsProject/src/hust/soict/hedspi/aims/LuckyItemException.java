...
public class LuckyItemException extends Exception {
	...
	public LuckyItemException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}
	...
	public LuckyItemException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
